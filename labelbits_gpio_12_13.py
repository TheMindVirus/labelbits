...
ALT_LABELS = \
[
    label("FSEL10", 0, 0b111, "GPIO 10"),
    label("FSEL11", 3, 0b111, "GPIO 11"),
    label("FSEL12", 6, 0b111, "GPIO 12"),
    label("FSEL13", 9, 0b111, "GPIO 13"),
    label("FSEL14", 12, 0b111, "GPIO 14"),
    label("FSEL15", 15, 0b111, "GPIO 15"),
    label("FSEL16", 18, 0b111, "GPIO 16"),
    label("FSEL17", 21, 0b111, "GPIO 17"),
    label("FSEL18", 24, 0b111, "GPIO 18"),
    label("FSEL19", 27, 0b111, "GPIO 19"),
